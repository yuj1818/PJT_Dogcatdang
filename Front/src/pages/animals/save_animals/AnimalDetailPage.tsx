  ...
  return (
    ...
    <Container>
      ...
      <div className="flex"
        ...
        <Rightside>
          <div className="flex"> <p style={{ fontSize: '25px' }}>{animalDetail?.breed.replace(/_/g, " ")} |  {animalDetail?.age}세</p> </div>
          <div className="flex"><p>보호기관 : </p>{animalDetail?.userNickname}</div>
          <div className="flex"><p>성별 : </p>{animalDetail?.gender}</div>
          <div className="flex"><p>체중: </p>{animalDetail?.weight}</div>
          <div className="flex"><p>실종일자 : </p>{animalDetail?.rescueDate ? "Y" : "N"}</div>
          <div className="flex"><p>실종위치 : </p>{animalDetail?.rescueLocation}</div>
          <div className="flex"
            style={{
            ...
            <p>특징 : </p>{animalDetail?.feature}</div>
        </Rightside>
      </div>
