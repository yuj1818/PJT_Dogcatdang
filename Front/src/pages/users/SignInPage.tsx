      ...
      <FormBox>
        ...
        <div className="flex flex-col items-center gap-9 w-2/5">
          ...
          <div className="flex gap-2">
            <a href=""><img src="/src/assets/naverLoginBtn.png" alt="" /></a>
            <a href={`https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id=${import.meta.env.VITE_GOOGLE_CLIENT_ID}&state=${import.meta.env.VITE_GOOGLE_STATE}&redirect_uri=${import.meta.env.VITE_GOOGLE_REDIRECT_URI}`}><img src="/src/assets/googleLoginBtn.png" alt="" /></a>
          </div>
        </div>
      </FormBox>
    </div>
